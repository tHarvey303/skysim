...
- Buttons to render neighboring tiles and add them to the current image for a larger field of view, to verify that the tiling and coordinate system are working correctly across tile boundaries. (E.g. top, bottom, left, right neighbors).
